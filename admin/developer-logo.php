...
<script>
	...
	function edit_developer(id){
		...
		$.ajax({
			url : 'ajax/developer/ajax-developer-edit.php',
			type : 'POST',
			data : {'id' : id},
			success : function(resp){
				...
				if(data != ''){
					...
					document.getElementById("developer_address").value = data.address;
					var dy_about_data = data.about;
					var data_about = decodeHtml(data.about);
					console.log(data_about);
					
					document.getElementById("developer_about").value = data_about;	
...
<script>
	$(document).ready(function(){
		...
		$("#submit").on('click', function(){
			...
			$.ajax({
				url : 'ajax/developer/ajax-developer-insert.php',
				type : 'POST',
				data : data,
				contentType : false,
				processData : false,
		...
		$("#update").on("click", function(){
			...
			$(".loader-icon-head").css('display', 'flex');
			$.ajax({
				url : 'ajax/developer/ajax-developer-update.php',
				type : 'POST',
				data : data,
				contentType : false,
				processData : false,
