    ...
    <div class="inner-left">
      <div class="top-box">
        <div class="box">
          ...
          <div class="media">
          <span class="no-project">245</span>
      ...
      <div class="inner-bottom-box">
        ...
        <div class="inner-other">
          ...
          <div class="box">
            ...
            <div class="media-body">
              <h5>Sub Locality</h5>
              <a href="#"><span>View Detail</span></a>
            </div>
          </div>
          </div>
...
<div class="inner-other">
  ...
  <div class="right-area fasfasdf">
    ...
    <div class="inner-left">
		<div class="box">
			<h6><i class="fa fa-building" aria-hidden="true"></i> Project List</h6> 
			<div class="inner-table switch-table">
				<table class="table">
					<thead>
					  <tr>
						 <th>Name</th>
					...
					<tbody>
						<?php
							$micro_site_hot_sql = "SELECT * FROM micro_site ORDER BY id DESC";
							$micro_site_hot_query = mysqli_query($conn, $micro_site_hot_sql);
							$check = '';
							$cal_check = '';
							while($micro_site_hot_row = mysqli_fetch_array($micro_site_hot_query)){
								$admin_p_name = $micro_site_hot_row['name'];
								$admin_p_id = $micro_site_hot_row['id'];
								$check_hot_projects = $micro_site_hot_row['hot_project'];
								$check_cal_projects = $micro_site_hot_row['emi_cal_status'];
								$check = $check_hot_projects == '1' ? 'checked' : ''; 
								$cal_check = $check_cal_projects == '1' ? 'checked' : ''; 
						?>
								<tr>
									<td class="name-heading"><?php echo $admin_p_name; ?></td>
									<td>
										<label class="switch">
											<input type="checkbox" name="hot_projects<?php echo $admin_p_id; ?>" onchange="select_hot_projects(this.value)" value="<?php echo $admin_p_id; ?>" <?php echo $check; ?> >
											<span class="slider round"></span>
										</label>
									</td>
									<td>
										<label class="switch">
											<input type="checkbox" name="add_cal<?php echo $admin_p_id; ?>" onchange="add_calculator_projects(this.value)" value="<?php echo $admin_p_id; ?>" <?php echo $cal_check; ?>>
											<span class="slider round"></span>
										</label>
									</td> 
								</tr>
